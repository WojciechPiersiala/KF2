...
Public Class Przewody_10749698
    ...
    Public Sub Przewody_9_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Przewod25_Down(sender As Object, e As MouseEventArgs) Handles Button32.MouseDown

    End Sub

    Private Sub Przewod25_UP(sender As Object, e As MouseEventArgs) Handles Button32.MouseUp

    End Sub

    Private Sub Przewod14_Down(sender As Object, e As MouseEventArgs) Handles Button31.MouseDown

    End Sub

    Private Sub Przewod24_UP(sender As Object, e As MouseEventArgs) Handles Button31.MouseUp

    End Sub

    Private Sub Przewod23_Down(sender As Object, e As MouseEventArgs) Handles Button30.MouseDown

    End Sub

    Private Sub Przewod23_UP(sender As Object, e As MouseEventArgs) Handles Button30.MouseUp

    End Sub

    Private Sub Przewod22_Down(sender As Object, e As MouseEventArgs) Handles Button29.MouseDown

    End Sub

    Private Sub Przewod22_UP(sender As Object, e As MouseEventArgs) Handles Button29.MouseUp

    End Sub

    Private Sub Przewod21_Down(sender As Object, e As MouseEventArgs) Handles Button28.MouseDown

    End Sub

    Private Sub Przewod21_UP(sender As Object, e As MouseEventArgs) Handles Button28.MouseUp

    End Sub

    Private Sub Przewod20_Down(sender As Object, e As MouseEventArgs) Handles Button27.MouseDown

    End Sub

    Private Sub Przewod20_UP(sender As Object, e As MouseEventArgs) Handles Button27.MouseUp

    End Sub

    Private Sub Przewod19_Down(sender As Object, e As MouseEventArgs) Handles Button26.MouseDown

    End Sub

    Private Sub Przewod19_UP(sender As Object, e As MouseEventArgs) Handles Button26.MouseUp

    End Sub

    Private Sub Przewod18_Down(sender As Object, e As MouseEventArgs) Handles Button25.MouseDown

    End Sub

    Private Sub Przewod18_UP(sender As Object, e As MouseEventArgs) Handles Button25.MouseUp

    End Sub

    Private Sub Przewod17_Down(sender As Object, e As MouseEventArgs) Handles Button24.MouseDown

    End Sub

    Private Sub Przewod17_UP(sender As Object, e As MouseEventArgs) Handles Button24.MouseUp

    End Sub

    Private Sub Przewod16_Down(sender As Object, e As MouseEventArgs) Handles Button23.MouseDown

    End Sub

    Private Sub Przewod16_UP(sender As Object, e As MouseEventArgs) Handles Button23.MouseUp

    End Sub

    Private Sub Przewod15_Down(sender As Object, e As MouseEventArgs) Handles Button22.MouseDown

    End Sub

    Private Sub Przewod15_UP(sender As Object, e As MouseEventArgs) Handles Button22.MouseUp

    End Sub

    Private Sub Przewod14_Down2(sender As Object, e As MouseEventArgs) Handles Button21.MouseDown

    End Sub

    Private Sub Przewod14_UP(sender As Object, e As MouseEventArgs) Handles Button21.MouseUp

    End Sub

    Private Sub Przewod13_Down(sender As Object, e As MouseEventArgs) Handles Button20.MouseDown

    End Sub

    Private Sub Przewod13_UP(sender As Object, e As MouseEventArgs) Handles Button20.MouseUp

    End Sub

    Private Sub Przewod12_Down(sender As Object, e As MouseEventArgs) Handles Button19.MouseDown

    End Sub

    Private Sub Przewod12_UP(sender As Object, e As MouseEventArgs) Handles Button19.MouseUp

    End Sub

    Private Sub Przewod11_Down(sender As Object, e As MouseEventArgs) Handles Button18.MouseDown

    End Sub

    Private Sub Przewod11_UP(sender As Object, e As MouseEventArgs) Handles Button18.MouseUp

    End Sub

    Private Sub Przewod10_Down(sender As Object, e As MouseEventArgs) Handles Button17.MouseDown

    End Sub

    Private Sub Przewod10_UP(sender As Object, e As MouseEventArgs) Handles Button17.MouseUp

    End Sub

    Private Sub Przewod9_Down(sender As Object, e As MouseEventArgs) Handles Button16.MouseDown

    End Sub

    Private Sub Przewod9_UP(sender As Object, e As MouseEventArgs) Handles Button16.MouseUp

    End Sub

    Private Sub Przewod8_Down(sender As Object, e As MouseEventArgs) Handles Button15.MouseDown

    End Sub

    Private Sub Przewod8_UP(sender As Object, e As MouseEventArgs) Handles Button15.MouseUp

    End Sub

    Private Sub Przewod7_Down(sender As Object, e As MouseEventArgs) Handles Button14.MouseDown

    End Sub

    Private Sub Przewod7_UP(sender As Object, e As MouseEventArgs) Handles Button14.MouseUp

    End Sub

    Private Sub Przewod6_Down(sender As Object, e As MouseEventArgs) Handles Button13.MouseDown

    End Sub

    Private Sub Przewod6_UP(sender As Object, e As MouseEventArgs) Handles Button13.MouseUp

    End Sub

    Private Sub Przewod5_Down(sender As Object, e As MouseEventArgs) Handles Button12.MouseDown

    End Sub

    Private Sub Przewod5_UP(sender As Object, e As MouseEventArgs) Handles Button12.MouseUp

    End Sub

    Private Sub Przewod4_Down(sender As Object, e As MouseEventArgs) Handles Button11.MouseDown

    End Sub

    Private Sub Przewod4_UP(sender As Object, e As MouseEventArgs) Handles Button11.MouseUp

    End Sub

    Private Sub Przewod3_Down(sender As Object, e As MouseEventArgs) Handles Button10.MouseDown

    End Sub

    Private Sub Przewod3_UP(sender As Object, e As MouseEventArgs) Handles Button10.MouseUp

    End Sub

    Private Sub Przewod1_Down(sender As Object, e As MouseEventArgs) Handles Button8.MouseDown

    End Sub

    Private Sub Przewod1_UP(sender As Object, e As MouseEventArgs) Handles Button8.MouseUp

    End Sub

    Private Sub Przewod2_Down(sender As Object, e As MouseEventArgs) Handles Button9.MouseDown

    End Sub

    Private Sub Przewod2_UP(sender As Object, e As MouseEventArgs) Handles Button9.MouseUp
