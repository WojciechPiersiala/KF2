...
Public Class Frez_08379
    ...
    Private Sub Button20_Click(sender As Object, e As EventArgs) Handles Button20.Click
        ...
        Else
            ...
            ReDim hConnect(3)
            Try
                Zmienna1_Not = tcClient.AddDeviceNotification(".bQGF11TrennmittelUnten", dataStream, 0, 1, AdsTransMode.OnChange, 100, 0, DBNull.Value)
                Zmienna1_Write = tcClient.CreateVariableHandle(".bQGF11TrennmittelUnten")

                Zmienna2_Not = tcClient.AddDeviceNotification(".bQGF11TrennmittelOben", dataStream, 1, 1, AdsTransMode.OnChange, 100, 0, DBNull.Value)
                Zmienna2_Write = tcClient.CreateVariableHandle(".bQGF11TrennmittelOben")

                Zmienna3_Not = tcClient.AddDeviceNotification(".bQHF3FormatAusfahr", dataStream, 2, 1, AdsTransMode.OnChange, 100, 0, DBNull.Value)
                Zmienna3_Write = tcClient.CreateVariableHandle(".bQHF3FormatAusfahr")

                Zmienna4_Not = tcClient.AddDeviceNotification(".bQHF3FormatAusfahr2", dataStream, 3, 1, AdsTransMode.OnChange, 100, 0, DBNull.Value)
                Zmienna4_Write = tcClient.CreateVariableHandle(".bQHF3FormatAusfahr2")

                Zmienna5_Not = tcClient.AddDeviceNotification(".bQHF3FormatLuftd", dataStream, 4, 1, AdsTransMode.OnChange, 100, 0, DBNull.Value)
                Zmienna5_Write = tcClient.CreateVariableHandle(".bQHF3FormatLuftd")

                Zmienna6_Not = tcClient.AddDeviceNotification(".bQHF3DrucklosSchalten", dataStream, 5, 1, AdsTransMode.OnChange, 100, 0, DBNull.Value)
                Zmienna6_Write = tcClient.CreateVariableHandle(".bQHF3DrucklosSchalten")
